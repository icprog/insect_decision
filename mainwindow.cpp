...
void MainWindow::create_model_box_pratt()
{
    ...
    layout->addWidget(label_d, 1, 0);
    layout->addWidget(sb_d, 1, 1);
    layout->addWidget(label_q1, 2, 0);
    layout->addWidget(sb_q1, 2, 1);
    layout->addWidget(label_q2, 3, 0);
    layout->addWidget(sb_q2, 3, 1);
    layout->addWidget(label_r1, 4, 0);
    layout->addWidget(sb_r1, 4, 1);
    layout->addWidget(label_seed, 0, 2);
    layout->addWidget(sb_seed, 0, 3);
    layout->addWidget(label_std_dev, 1, 2);
    layout->addWidget(sb_std_dev, 1, 3);
    ...
    layout->addWidget(label_y2_0, 3, 2);
    layout->addWidget(sb_y2_0, 3, 3);
    layout->addWidget(label_l1, 4, 2);
    layout->addWidget(sb_l1, 4, 3);
...
{
//    QAction * selectedAction = combo_menu->itemData(index, Qt::UserRole).value<QAction *>();
//    if (selectedAction)
//    {
